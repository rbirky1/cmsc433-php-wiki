    ...
    <div id="sidebar">
      ...
      <div class="section">
        <ul>
          ...
          <li><a href="./index.php?page=Create">Create a Page</a></li>
        </ul>
      </div>
    </div>
...
<?
   ...
   if ($_GET['page'] == "All Pages" ){
    ...
    <div class='content'>";
     echo "<form action='./index.php?page=$page&amp;edit=true' method='post'>Name:<input type='text' name='name'><p><input type='submit'></p>
</form>";
      if ($_POST['name']){ $apage=$_POST['name']; createPage($apage, $dir); echo "<p><a href='./index.php?page=$apage&amp;edit=true'>Edit new page</a></p>";}
   } else {
   if ($_GET['edit']){
	editPage($page, $dir);
   } elseif ($_GET['delete']){
    ...
    <div class='content'>
      <h1>$page</h1>
      <p>$page does not exist. You can create it <a href='./index.php?page={$page}&amp;edit=true'>here</a>.";
   } else {
	viewPage($page, $dir);
   }
  }
...
function editPage($page, $dir){
   ...
   echo "</ul><div class='content'>";
   if (!file_exists($dir.$page)){ createPage($page,$dir);}
